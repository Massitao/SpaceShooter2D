...
public class ObjectPool : MonoSingleton<ObjectPool>
{
    ...
    public enum PoolType { Rookie, Bomber, Toxic, Reckless, Watcher, Avoider, Collector, Asteroid, Explosion, ToxicSmoke, PlayerLaser, TripleShotLaser, HeatSeekLaser, EnemyLaser, Bomb, Powerup }
